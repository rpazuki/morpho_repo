    ...
    def train(self, 
        ...
        for epoch in range(epochs):
            if sample_gradiants:
                ...
                total_loss, loss_vals, _ =  self._train_batch_(epoch, 
                                                               batch_size,
                                                               datasets_sizes,
                                                               False,
                                                               regularised,
            ...
            sample_ws[epoch] = self.losses[1].loss_weight
        ...
        return (samples_losses, samples_params, samples_grads, sample_ws)    