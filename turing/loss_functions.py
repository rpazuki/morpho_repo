    ...
    def __init__(self,
        ...
        if sigma_a is None:
            self.sigma_a = tf.Variable(
                [init_value], dtype=dtype, name="sigma_a",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
        ...
        if sigma_s is None:
            self.sigma_s = tf.Variable(
                [init_value], dtype=dtype, name="sigma_s",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
        ...
        if mu_a is None:
            self.mu_a = tf.Variable(
                [init_value], dtype=dtype, name="mu_a",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
        ...
        if rho_a is None:
            self.rho_a = tf.Variable(
                [init_value], dtype=dtype, name="rho_a",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
        ...
        if rho_s is None:
            self.rho_s = tf.Variable(
                [init_value], dtype=dtype, name="rho_s",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
        ...
        if kappa_a is None:
            self.kappa_a = tf.Variable(
                [init_value], dtype=dtype, name="kappa_a",
                constraint=lambda z: tf.clip_by_value(z, 0, 1e10))
